...
void ComponentTreeAdjustmentByFlatzone::buildMergedAndNestedCollections(ComponentTreeFZPtr tree, std::vector<FlatZonePtr>& flatZone,  int pixelUpperBound, int newGrayLevel, bool isMaxtree){
	Fb.clear();
...
void ComponentTreeAdjustmentByFlatzone::updateTree(ComponentTreeFZPtr tree, NodeFZPtr node) {
...
void ComponentTreeAdjustmentByFlatzone::adjustMinTree(ComponentTreeFZPtr mintree, ComponentTreeFZPtr maxtree, std::vector<NodeFZPtr>& nodesToPruning) {
...
void ComponentTreeAdjustmentByFlatzone::adjustMaxTree(ComponentTreeFZPtr maxtree, ComponentTreeFZPtr mintree, std::vector<NodeFZPtr>& nodesToPruning) {
    for (NodeFZPtr rSubtree : nodesToPruning) {  
