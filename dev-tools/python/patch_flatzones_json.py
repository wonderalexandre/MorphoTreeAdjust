...
# Helper utility to copy flatzone metrics from one reference method
# to another method using the same JSON format.
#
# The current use case is filling missing fields in older or partial outputs
# without depending on the benchmark's historical naming scheme anymore.
#
# Example:
# python3 patch_flatzones_json.py \
#   --in out_target.json \
#   --ref out_reference.json \
#   --out out_fixed.json \
#   --target-method target_method --ref-method reference_method
